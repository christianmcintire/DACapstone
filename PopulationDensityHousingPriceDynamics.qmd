...
# 4. Optional: View the cleaned data
...
#### Figure 1: Southeastern United States Choropleth
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 1: Southeastern US Choropleth with State Borders"
#| fig-width: 25
#| fig-height: 20
...
#### Figure 2: Midwestern United States Choropleth
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 2: Midwestern US Choropleth"
#| fig-width: 20
#| fig-height: 22
...
#### Figure 3: Southeastern and Midwestern United States Choropleth
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 3: SE & MW States Choropleth"
#| fig-width: 20
#| fig-height: 25
...
#### Figure 4: Historical HPI Comparison
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 4: Time Series Data Aggregation by Region"
...
#### Figure 5: Southeastern and Midwestern United States ARIMA Forecasting
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 5: ARIMA Modeling Aggregated by Region"
...
#### ARIMA Forecast Table (1975–2030)
...
#| warning: false
#| code-fold: true
#| code-summary: "ARIMA Forecast Table (1975–2030) For Reference Only"
...
#### Table 1: ARIMA Summary Table of Housing Price Index Forecasts
...
#| warning: false
#| code-fold: true
#| code-summary: "Table 1: Summary of Housing Price Index Forecasts (1975–2030)"
...
arima_summary_table %>%
  gt() %>%
  tab_header(
    title = "Table 1: Summary of Housing Price Index Forecasts (1975–2030)",
...
#### Figure 6: Zillow Housing Data Scatterplot
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 6: Zillow Housing Data Time Series Scatterplot"
...
#### Figure 7: Zillow Housing Data ARIMA Forecast
...
#### Table 2: Zillow Home Price Estimates - ARIMA Model Summary Table
...
#| warning: false
#| code-fold: true
#| code-summary: "Table 2: Zillow ARIMA Summary Table"
...
zillow_arima_summary_table %>%
  gt() %>%
  tab_header(
    title = "Table 2: Summary of Zillow Home Price Forecasts (2000–2030)",
    subtitle = "Southeastern and Midwestern Regions"
  ) %>%
  fmt_number(
    columns = vars(
...
#| warning: false
#| code-fold: true
#| code-summary: "Hedonic Modeling Dataset Merging"
...
#### Figure 8: Southeastern and Midwestern County Population Choropleth
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 8: Choropleth of 2023 County Population"
#| fig-width: 20
#| fig-height: 25
...
#### Figure 9: Chicago Area Choropleth
...
#| warning: false
#| code-fold: true
#| code-summary: "Zoomed Choropleth - Chicago Area"
#| fig-width: 20
#| fig-height: 16
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 10: Zoomed Choropleth - Florida Area"
#| fig-width: 20
#| fig-height: 16
...
#### Table 3: Hedonic Modeling table
...
#| warning: false
#| code-fold: true
#| code-summary: "Table 3: Grouped Regression Table (SE & MW States Only)"
...
# Define SE and MW states (all lowercase)
...
hedonic_df_regional <- hedonic_df %>%
  ...
  filter(!is.na(region))  # keep only SE and MW states

# Confirm multiple state levels exist
state_levels <- unique(hedonic_df_regional$state)
print(state_levels)

# Refit model on SE & MW states only
hedonic_model_grouped <- lm(
  median_home_price ~ log(pop_2023) + monthly_payment_q32024 + factor(state),
...
regression_table_grouped <- tbl_regression(
  ...
  modify_caption("**Table 3: Hedonic Model: Median Home Price ~ log(Population), Mortgage Payment, State Fixed Effects**") %>%
  bold_labels()

regression_table_grouped
```

### Hedonic Modeling Visualizations - Fixed Effects

#### Figure 11 - Midwestern Fixed Effects
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 11: Midwestern Fixed Effects"
#| fig-width: 10
#| fig-height: 6
...
#### Figure 12 - Southeastern Fixed Effects
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 12: Southeastern Fixed Effects"
#| fig-width: 10
#| fig-height: 6
...
### BREAK - FINAL VISUALIZATIONS

#### Figure 13 - Scatterplot 1 - MW
...
#| warning: false
#| code-fold: true
#| code-summary: "Figure 13 Midwestern Population Growth vs. Home Prices"
#| fig-width: 10
#| fig-height: 6
...
#| warning: false
#| code-fold: true
#| code-summary: "Southeastern Population Growth vs. Home Prices"
#| fig-width: 10
#| fig-height: 6
...
southeast_plot <- scatter_data %>%
  ...
  scale_y_continuous(labels = label_dollar()) +
  scale_x_continuous(limits = c(-15, 20)) +  # <- Set matching limits
  theme_linedraw(base_size = 14)

print(southeast_plot)
```

#### **Figure 15 - Scatterplot 3 - Comparison**
...
#| warning: false
#| code-fold: true
#| code-summary: "Overlayed Growth vs. Price Comparison"
#| fig-width: 10
#| fig-height: 6
